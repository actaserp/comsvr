package com.actas.cmob.controller.seongwoo;

import com.actas.cmob.DTO.Themoon.CA609Dto;
import com.actas.cmob.DTO.Themoon.CA609PopDto;
import com.actas.cmob.Service.seongwoo.CA609ServiceWoo;
...
@RequestMapping(value = "/ca609sw", method = RequestMethod.POST)
public class AppCA609WooController {
    ...
    private final CA609ServiceWoo authService;
